function View() {
    ...
    this.parallaxStrengthBackground = 0.2
    this.parallaxStrengthForeground = 0.1
    this.parallaxFactor = 0

    this.isReadyContext = false
    this.isReadyBackdropImage = false
    this.isReadyBackdropImageInverted = false
    this.isReadyBackdropImageTemp = false
    this.isReadyBackdropImageTempInverted = false
    ...
    this.renderModel = function(model) {
        if(model.isReady && view.isReadyContext && view.isDirty) {
            ...
            */
            ...
            let image = null
            if(view.isReadyBackdropImage) {
                image = view.backdropImage
            } else if(view.isReadyBackdropImageTemp) {
                image = view.backdropImageTemp
            }
            ...
            if(image != null) {
                ...
                if(ratioClient < ratioImageEffective) {
                    ...
                    width = height * view.backdropImageTemp.width / view.backdropImageTemp.height
                    x = - (width - window.innerWidth * view.pixelRatio) / 2
                    y = - height * view.parallaxStrengthBackground * view.parallaxFactor
                } else {
            ...
            image = null
            if(view.isReadyBackdropImageInverted) {
                image = view.backdropImageInverted
            } else if(view.isReadyBackdropImageTempInverted) {
                image = view.backdropImageTempInverted
            }
            ...
            if(image != null) {
                ...
                if(ratioClient < ratioImageEffective) {
                    ...
                    width = height * view.backdropImageTemp.width / view.backdropImageTemp.height
                    x = - (width - window.innerWidth * view.pixelRatio) / 2
                    y = - height * view.parallaxStrengthForeground * view.parallaxFactor
                } else {
                    width = window.innerWidth * view.pixelRatio
                    height = width * image.height / image.width
                    x = - (width - window.innerWidth * view.pixelRatio) / 2
